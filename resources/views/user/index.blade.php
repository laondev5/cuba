...
<section class="bg-white" >
  <div class="container mx-auto">
      ...
      <div class="w-[85%] mx-auto flex  jutify-center flex-wrap justify-center md:justify-between mb-[103px]">
        <div class="w-[250px] md:w-[350px] h-[250px] md:h-[350px] lg:w-[433px] lg:h-[433px] shadow-lg bg-[url('/images/vision.png')] shadow-blue-400/10 
        " style="background: url('images/vision.png')"></div>
        <div class="w-[250px] md:w-[350px] h-[250px] hd:w-[350px] lg:w-[433px] lg:h-[433px] shadow-lg bg-[url('/images/vision.png')] shadow-blue-400/10 "></div>
      </div>
      {{--end card section--}}
...
<section class="my-8">
  ...
  <div class=" flex flex-wrap justify-evenly mb-[103px]">
        <div class="w-[200px] md:w-[250px] h-[200px] md:h-[250px] lg:w-[370px] lg:h-[370px] shadow-lg bg-[url('/images/vision.png')] shadow-blue-400 opacity-10
        " style="background: url('images/vision.png')"></div>
        <div class="w-[200px] md:w-[250px] h-[200px] md:h-[250px] lg:w-[370px] lg:h-[370px] shadow-lg bg-[url('/images/vision.png')] shadow-blue-400 opacity-10
        " style="background: url('images/vision.png')"></div>
        <div class="w-[200px] md:w-[250px] h-[200px] md:h-[250px] lg:w-[370px] lg:h-[370px] shadow-lg bg-[url('/images/vision.png')] shadow-blue-400 opacity-10"></div>
      </div>
  </div>
...
<div class="accordion accordion-flush" id="accordionFlushExample">
  ...
  <div class="accordion-item border-l-0 border-r-0 rounded-none bg-gray-100 bg-opacity-20 mt-4">
  ...
  <div class="accordion-item border-l-0 border-r-0 border-b-0 rounded-none bg-gray-100 bg-opacity-20 mt-4">
...
<section class="bg-gray-100 bg-opacity-20 py-4" id="contact_us">
  <div class="container mx-auto">
    ...
    <div class="flex  flex-col md:flex-row ">
        <div class="flex-1">
          <div class="py-3">
            <h1 class="text-2xl font-bold text-[#0B2347]">Give us a call or email us</h1>
          </div>
          <h1 class="text-md my-4">No 4 road G, Barnawa GRA, Kaduna <br/>
            2055 Limestone Rd, STE 200-C Wilminton, DE 19898, United State
          </h1>
          <h1 class="text-md my-4">09099589351, 07034218070</h1>
          <h1 class="text-md my-4">@thestatedev@info.com</h1>
