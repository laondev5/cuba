...
<section class=" bg-[#5091F1] pt-[25px] h-[60vh] md:h-[30vh] lg:h-[73vh] overflow-hidden">
    <div class="container mx-auto pt-4">
        <div class="flex items-center justify-between">
            <div class="py-4 flex flex-col w-[50%] justify-center lg:justify-start lg:ml-24">
                <h1 class="text-2xl font-semibold text-white">Are you looking to learn</h1>
                <h1 class="text-4xl font-bold text-[#0B2347] py-4">mobile app development ?</h1>
                <p class="text-md text-gray-200 w-[80%]">We have put together the best environment and equipmment to enhance the <span class="font-semibold text-[#0B2347]">learning</span> 
                    and <span class="font-semibold text-[#0B2347]">development</span> of everyone that walk through our door
                </p>
                <button @click="mobileModal=true" class="mt-6 w-36 py-3 px-6 rounded-lg bg-[#0B2347] hover:bg-white text-white hover:text-[#0B2347] transition-all ease-in-out duration-300 shadow-md shadow-blue-900/40">
                    Enroll now
                </button>
            </div>
            <div class="hidden lg:flex items-center justify-center mr-24">
                <img src="images/mb.png" alt="" class="w-[750px] h-[400px] mt-12">
            </div>
        </div>
    </div>
    ...
    <div class="contaimer mx-24 py-8">
        ...
        <div class="mt-8 flex flex-wrap justify-evenly py-4">
            ...
            <div @click="webModal" class="w-[290px] px-3 py-6 rounded-sm shadow-lg shadow-blue-500/5 hover:animate-bounce hover:bg-green-200 transition-all ease-linear duration-500">
                <h1 class="text-2xl font-bold text-center text-green-600 mb-4">Android and IOS</h1>
                <ul class="text-lg font-semibold text-[#0B2347] py-4 gap-4 text-center">
